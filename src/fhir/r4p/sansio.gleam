...
pub fn catalogentry_resp(
  ...
  any_resp(resp, resources.catalogentry_decoder(), "CatalogEntry")
}
...
pub fn deviceusestatement_resp(
  ...
  any_resp(resp, resources.deviceusestatement_decoder(), "DeviceUseStatement")
}
...
pub fn documentmanifest_resp(
  ...
  any_resp(resp, resources.documentmanifest_decoder(), "DocumentManifest")
}
...
pub fn media_create_req(
  ...
  any_create_req(resources.media_to_json(resource), "Media", client)
}
...
pub fn media_resp(resp: Response(String)) -> Result(resources.Media, ErrResp) {
  any_resp(resp, resources.media_decoder(), "Media")
}
...
pub fn medicinalproduct_resp(
  ...
  any_resp(resp, resources.medicinalproduct_decoder(), "MedicinalProduct")
}
...
pub fn requestgroup_resp(
  ...
  any_resp(resp, resources.requestgroup_decoder(), "RequestGroup")
}
...
pub fn researchdefinition_resp(
  ...
  any_resp(resp, resources.researchdefinition_decoder(), "ResearchDefinition")
}
